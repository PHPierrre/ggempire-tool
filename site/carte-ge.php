...
<meta charset='utf-8'>
<title>Carte du Glacier Eternel</title>
    ...
    <script type='text/javascript'>
      function drawVisualization() {
          var data = google.visualization.arrayToDataTable([
            ['Joueur','latitude','lontitude','legende/niveau','taille'],
<?php
$reponse = mysql_query("SELECT * FROM cartege ") or die(mysql_error());
...
<center><div id="visualization" style="width:2000px;height:900px;margin-top:-90px; z-index:-10; margin-left:-200px">
</div></center>
