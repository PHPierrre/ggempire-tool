...
<br>
<center>Aller je vous présente une liste d\'espionnage des fieffé coquin avec l\'aide de sys-007 pour les captures d\'écran.</center><br><br>
'; 

echo'Niveau 1 - 1 victoire pour passer au niveau 2';
echo'<center><img src="http://x/site/image/fc/2-1.jpg" /></center>';
echo'Niveau 2 - 1 victoire pour passer au niveau 3';
echo'<center><img src="http://x/site/image/fc/3-1.jpg" /></center>';
echo'Niveau 3 - 1 victoire pour passer au niveau 4';
