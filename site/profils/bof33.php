...
//recup des donnes a la base de donné
	$reponse = mysql_query('SELECT pseudo, gradej, grades, emailp, departement, skype, sweb, signature FROM validation WHERE pseudo=\'bof33\'') or die(mysql_error());?>
