...
//recup des donnes a la base de donné
	$reponse = mysql_query('SELECT pseudo, gradej, grades, emailp, departement, skype, sweb, signature FROM validation WHERE pseudo=\'pierre151\'') or die(mysql_error());?>
...
?>
    ...
    <?
	if($_SESSION['pseudo'] == 'pierre151'){
?>
   <center> <a href="modifier-profil.php?pseudo=pierre151">Modifier mon profil</a></center>
    <?php } ?></div></center> 
    <?
include('../cont.php');
}else{include('../noco.php');}
