...
<?php
$reponse = mysql_query("SELECT * FROM cartelge ") or die(mysql_error());
...
<?php } ?>  
			['wtv666',1187,-851,'36',36],
			['wtv666',1189,-852,'36',36],
			['wtv666',1186,-853,'36',36],
			['wtv666',1181,-851,'36',36],
]);
...
<div id="visu" style="width:2000px;height:900px;margin-top:0px; margin-left:-200px;">
</div>
<?php
}else{include('noco.php');}
}else{include('noco.php');}
